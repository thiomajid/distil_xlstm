...
FrobeniusNormReduction = Literal["average", "ratio", "block_wise"]

AlignmentLoss = Literal["cosine", "frobenius"]
""" Indicates which metric to use for hidden representation alignement"""
...
class FrobeniusLoss(nn.Module):
    ...
    def __init__(self, reduction: FrobeniusNormReduction) -> None:
        super().__init__()
    ...
    def __ratio_reduction(
        ...
        num_xlstm_blocks, batch_size, seq_len, hidden_dim = student_hidden_states.shape
